document.addEventListener("DOMContentLoaded", () => {
  ...
  const slideTitles = [
    "Hückelhoven, Baujahr 1992",
    "Aachen, Baujahr 1967",
    "Wassenberg, Baujahr 1965",
  ];

  const slideDescriptions = [
    "Gepflegtes Mehrfamilienhaus mit 7 Wohneinheiten, übernommen zur Bestandshaltung. Stabile Substanz und attraktive Perspektive für langfristige Mietentwicklung.",
    "Attraktives Investmentobjekt mit Wohn- und Gewerbeeinheiten in frequentierter Lage – direkt gegenüber dem Hauptbahnhof im Herzen von Aachen.",
    "Solides Investment bestehend aus einem Mehrfamilienhaus und einem Bungalow. Erworben zur langfristigen Mietsteigerung und nachhaltigen Wertentwicklung.",
  ];
